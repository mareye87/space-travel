...
import anouschehPng from "./assets/crew/image-anousheh-ansari.png";
import anouschehWebp from "./assets/crew/image-anousheh-ansari.webp";

import lunchPrt from "./assets/technology/image-launch-vehicle-portrait.jpg";
import lunchLnd from "./assets/technology/image-launch-vehicle-landscape.jpg";

import spaceportLnd from "./assets/technology/image-spaceport-landscape.jpg";
import spaceportPrt from "./assets/technology/image-spaceport-portrait.jpg";

import spaceCapsulePrt from "./assets/technology/image-space-capsule-portrait.jpg";
import spaceCapsuleLnd from "./assets/technology/image-space-capsule-landscape.jpg";
...
export const data = {
  ...
  technology: [
    ...
    },
    {
      name: "Spaceport",
      images: {
        portrait: spaceportPrt,
        landscape: spaceportLnd,
      },
      description:
    ...
    },
    {
      name: "Space capsule",
      images: {
        portrait: spaceCapsulePrt,
        landscape: spaceCapsuleLnd,
      },
      description:
